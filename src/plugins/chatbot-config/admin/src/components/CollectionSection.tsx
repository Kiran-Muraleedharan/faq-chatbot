...
                  {/* BIN ICON: Small and clean deletion button */}
                  <Box paddingRight={4}>
                    <Button
                      variant="ghost"
...
                      style={{ padding: '8px' }}
                    >
                      <Trash fill="danger600" width="16px" height="16px" />
                    </Button>
                  </Box>
                </Accordion.Header>
...
                            >
                                <SingleSelectOption value="card 1">card 1</SingleSelectOption>
                                <SingleSelectOption value="card 2">card 2</SingleSelectOption>
                            </SingleSelect>
                        </Box>
                    </Box>
                  </Box>
